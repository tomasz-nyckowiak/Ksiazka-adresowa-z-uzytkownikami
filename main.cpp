...
void WyswietlenieDanychAdresata(vector <Adresat> &adresaci, int numerAdresata)
{
    cout << adresaci[numerAdresata].id << ") " << adresaci[numerAdresata].imie << " " << adresaci[numerAdresata].nazwisko << endl;
    cout << "Telefon: " << adresaci[numerAdresata].telefon << endl;
    cout << "Email: "<< adresaci[numerAdresata].email << endl;
    cout << "Adres: "<< adresaci[numerAdresata].adres << endl;
}
...
void WyswietlKsiazkeAdresowa(vector <Adresat> &adresaci, int iloscOsob)
{
    if (iloscOsob != 0)
    {
        ...
        {
            WyswietlenieDanychAdresata(adresaci, i);
        }
        cout << endl;
        system("pause");
    }
...
int DodajAdresata(vector <Adresat> &adresaci, int iloscOsob, int idZalogowanegoUzytkownika, int ID)
{
    ...
    if (plik.good() == true)
    {
        plik << adresaci[iloscOsob].id << '|' << adresaci[iloscOsob].idUzytkownika << '|' << adresaci[iloscOsob].imie << '|' << adresaci[iloscOsob].nazwisko << '|' << adresaci[iloscOsob].telefon << '|' << adresaci[iloscOsob].email << '|' << adresaci[iloscOsob].adres << '|' << endl;
        plik.close();
    }
    else
    {
...
void ZapisDoPlikuPoEdycjiAdresata(vector <Adresat> &adresaci, int numerEdytowanegoAdresata, int ID, int idZalogowanegoUzytkownika)
{
    ...
    if (plikTymczasowy.good() == true)
    {
        ...
        {
            if (tymczasowy[j].id == ID && tymczasowy[j].idUzytkownika == idZalogowanegoUzytkownika)
            {
...
void EdytujAdresata(vector <Adresat> &adresaci, int iloscOsob, int idZalogowanegoUzytkownika)
{
    string imie, nazwisko, telefon, email, adres;
    char wybor;
    int ID;
    ...
    if (iloscOsob != 0)
    {
        ...
        while (i < iloscOsob)
        {
            if (adresaci[i].id == ID)
            {
                ...
                ZapisDoPlikuPoEdycjiAdresata(adresaci, i, ID, idZalogowanegoUzytkownika);
            }
            i++;
        }
...
void AktualizacjaLiczbyAdresatowWPliku(vector <Adresat> &adresaci, int ID, int idZalogowanegoUzytkownika)
{
    vector <Adresat> tymczasowy;
    Adresat tymczasowiAdresaci;
...
int UsunAdresata(vector <Adresat> &adresaci, int iloscOsob, int idZalogowanegoUzytkownika)
{
    int ID;
    int i = 0;
    int temp = 0; //zmienna pomocnicza
        ...
        while (i < iloscOsob)
        {
            if (adresaci[i].id == ID)
            {
                ...
                if (wybor == 't')
                {
                    ...
                    AktualizacjaLiczbyAdresatowWPliku(adresaci, ID, idZalogowanegoUzytkownika);
    ...
    while (1)
    {
        ...
        else
        {
            ...
            if (wybor == '1')
                ...
                iloscOsobWKsiazceAdresowej = UsunAdresata(adresaci, iloscOsobWKsiazceAdresowej, idZalogowanegoUzytkownika);
            else if (wybor == '6')
                EdytujAdresata(adresaci, iloscOsobWKsiazceAdresowej, idZalogowanegoUzytkownika);
            else if (wybor == '7')
